...
const FormField: ISwapFormField = {
  ...
  methods() {
    ...
    return {
      ...
      iconClick() {
        ...
        form.setFieldValue('LabourField', '');
        form.setFieldValue('Selectjia', '');
        form.setFieldExtendValue('LabourField', '');
      ...
      rowClick(record: any) {
        ...
        _this.setState({ dataSource: newData, isModalVisible: false }, () => {
          ...
          form.setFieldExtendValue('TestLabour', record);
        });
      },
    };
  },
  ...
  fieldDidUpdate() {
    if (!this.props.runtimeProps.viewMode) {
      ...
      form.setFieldValue('TestLabour', this.state.detailname);
      form.setFieldExtendValue('TestLabour', this.state.detailname);
    }
  },
  ...
  fieldRender() {
    ...
    const rowSelection = {
      ...
      onChange: (selectedRowKeys, selectedRows) => {
        ...
        form.setFieldExtendValue('LabourField', newData[0].contract_name);
        form.setFieldExtendValue('Selectjia', newData[0].team);
        this.setState({
