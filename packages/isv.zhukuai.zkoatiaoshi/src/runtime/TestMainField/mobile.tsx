...
const FormField: ISwapFormField = {
    ...
    methods() {
        ...
        return {
            ...
            onChangedata1(data, index) {
                ...
                const datetime = newdata.getFullYear() +
                    '-' +
                    (newdata.getMonth() + 1) +
                    '-' +
                    newdata.getDate();
    ...
    fieldDidUpdate() {
        if (!this.props.runtimeProps.viewMode) {
            ...
            let str0 = '设备名称  单位  规格型号  维保内容  工时数  人工合价  材料合价  小计';
        ...
        const sidebar = (
            <div style={{ width: '100vw' }}>
                <SearchBar
                    ...
                    showCancelButton
                    onCancel={() => this.setState({ showElem: 'none', SearchBarvalue: '' })} />
        ...
        const treesidebar = (
            <div style={{ width: '100vw' }}>
                <SearchBar
                    ...
                    onCancel={() => this.setState({ showElem2: 'none', SearchBarvalue: '' })}
                    showCancelButton />
                                                                            ...
                                                                            <div className="m-field-content left">
                                                                                <div className="input-wrapper">
                                                                                    <InputItem
                                                                                        ...
                                                                                        onChange={e => this.methods().onInputchange(
                                                                                            'name',
                                                                                            index,
                                                                                            e
                                                                                        )} />
