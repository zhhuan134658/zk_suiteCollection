    ...
    return {
      ...
      handleClick(item: any) {
        ...
        _this.setState({ Inputvalue: item.name, showElem: 'none' }, () => {
          form.setFieldValue('OtherContract', item.name);
          form.setFieldExtendValue('OtherContract', item.name);
          form.setFieldValue('Selectjia', item.sub_unit);
          form.setFieldExtendValue('Selectjia', item.sub_unit);
          form.setFieldValue('OtherConmoney', item.contract_money);
          form.setFieldExtendValue('OtherConmoney', item.contract_money);
        });
      },
      onExtraClick() {
        const { form } = _this.props;
