...
const FormField: ISwapFormField = {
  ...
  fieldRender() {
    ...
    const required = form.getFieldProp('TestInspec', 'required');
    ...
    const etColumns = [
      ...
      },
      {
        ...
        render: (_, record: any) => {
          return (
            <Input
              value={record.check_situation}
              placeholder="请输入"
              onChange={e => {
                record.check_situation = e.target.value;
              }}
            />
          );
        },
      },
      {
        ...
        render: (_, record: any) => {
          return (
            <Input
              value={record.rectify}
              placeholder="请输入"
              onChange={e => {
                record.rectify = e.target.value;
              }}
            />
          );
        },
